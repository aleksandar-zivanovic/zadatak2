...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $orderedItem4->setPricePerPiece($product7->getPrice());
        ...
        $orderedItem5->setPricePerPiece($product8->getPrice());
        $orderedItem6 = new OrderedItem();
        $orderedItem6->setRelatedOrder($order3);
        $orderedItem6->setProduct($product6);
        $orderedItem6->setQuantity(2);
        $orderedItem6->setCreatedAt(new \DateTime());
        $orderedItem6->setPricePerPiece(150);
        $orderedItem7 = new OrderedItem();
        $orderedItem7->setRelatedOrder($order3);
        $orderedItem7->setProduct($product5);
        $orderedItem7->setQuantity(1);
        $orderedItem7->setCreatedAt(new \DateTime());
        $orderedItem7->setPricePerPiece($product5->getPrice());
        $orderedItem8 = new OrderedItem();
        $orderedItem8->setRelatedOrder($order3);
        $orderedItem8->setProduct($product4);
        $orderedItem8->setQuantity(1);
        $orderedItem8->setCreatedAt(new \DateTime());
        $orderedItem8->setPricePerPiece($product4->getPrice());
        ...
        $manager->persist($orderedItem6);
        $manager->persist($orderedItem7);
        $manager->persist($orderedItem8);
